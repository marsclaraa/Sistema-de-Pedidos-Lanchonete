...
<body style="background-color: #F2CEAB"  style="bg-gradient">
    <nav class="navbar border-bottom border-body" style="background-color: #72B5A4" data-bs-theme="dark">
        <a class="navbar-brand" href="#">   Lanche Delícia</a>
